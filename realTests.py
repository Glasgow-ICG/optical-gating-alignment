...
settings1 = {}
settings1.update({'drift':[0,-1]})#starting drift corrections[-6,-2]
settings2 = {}
settings2.update({'drift':[1,-1]})#starting drift corrections[-5,-2]
settings3 = {}
settings3.update({'drift':[12,7]})#starting drift corrections[6,6]

# seq0 with seq0
print('Comparing sequence #0 with itself...')
seq0,seq0 = matchFrames(seq0,seq0,settings0)
...
s0,s0m = matchFrames(seq0,seq0m,settings0)
alignment1, alignment2, rollFactor = nCascadingNWA(s0,s0m,log=False)
print('Wrapped by {0} steps;'.format(rollFactor))
print('Aligned sequence #0:\t{0};'.format(alignment1))
...
s0,s0d = matchFrames(seq0,seq0d,settings0)
alignment1, alignment2, rollFactor = nCascadingNWA(s0,s0d,log=False)
print('Wrapped by {0} steps;'.format(rollFactor))
print('Aligned sequence #0:\t{0};'.format(alignment1))
...
s0,s1 = matchFrames(seq0,seq1,settings1)
alignment1, alignment2, rollFactor = nCascadingNWA(s0,s1,log=False)
print('Wrapped by {0} steps;'.format(rollFactor))
print('Aligned sequence #0:\t{0};'.format(alignment1))
...
s0,s2 = matchFrames(seq0,seq2,settings2)
alignment1, alignment2, rollFactor = nCascadingNWA(s0,s2,log=False)
print('Wrapped by {0} steps;'.format(rollFactor))
print('Aligned sequence #0:\t{0};'.format(alignment1))
...
s0,s3 = matchFrames(seq0,seq3,settings3)
alignment1, alignment2, rollFactor = nCascadingNWA(s0,s3,log=False)
print('Wrapped by {0} steps;'.format(rollFactor))
print('Aligned sequence #0:\t{0};'.format(alignment1))
