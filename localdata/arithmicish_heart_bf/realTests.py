...
sequenceName = './localdata/arithmicish_heart_bf/seq{0}/'
blurSigma = 3
...
# settings for drift
settings0 = {}
settings0.update({'drift':[0,0]})#starting drift corrections[0,0]
settings1 = {}
settings1.update({'drift':[0,0]})#starting drift corrections[0,0]
settings2 = {}
settings2.update({'drift':[0,0]})#starting drift corrections[0,0]
settings3 = {}
settings3.update({'drift':[0,0]})#starting drift corrections[0,0]
